...
================================================================================
  ...
  - Core flow: TypeScript vừa đủ -> component/template/signals -> DI -> router -> forms -> HTTP -> RxJS -> Todo app
  - Default stack: standalone + signals + reactive forms + functional guards/interceptors
  - Rule nhớ nhanh: signal cho state; Observable cho HTTP/route/search; NgRx và BehaviorSubject học sau core
